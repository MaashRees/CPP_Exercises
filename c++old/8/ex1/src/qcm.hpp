...
#define ANSWER_1 true // oui, car l'implémentation 1 est plus efficace parce qu'elle utilise std::move pour 
...
#endif
// Est-ce que l'implémentation 1 est meilleure que l'implémentation 2?
#define ANSWER_2 false // non, car l'implémentation 1 est incorrecte
...
#define ANSWER_3 true à cause de la fuite mémoire lors de la non désallocation des values
...
// Est-ce que l'utilisation de la classe ci-dessus est susceptible de créer des problèmes de mémoire (fuite,
// double-déallocation, etc.) ?
#define ANSWER_4 false // non, car les valeurs sont bien désallouées et les keys sont bien désallouées car elles sont des unique_ptr
...
// Est-ce que l'utilisation de la classe ci-dessus est susceptible de créer des problèmes de mémoire (fuite,
// double-déallocation, etc.) ?
#define ANSWER_5 true  // a cause de la double désallocation des valeurs
...
#define ANSWER_15 false // car f retourne une l-value (reférence)
// 16. L'expression f(w, f(g(x + 1, y), z)) est-elle une r-value?
#define ANSWER_16 false // car f retourne une l-value (reférence)
